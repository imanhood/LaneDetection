...
class Lane:
  ...
  def get_line_markings(self, frame=None):
    ...
    _, sxbinary = edge.threshold(hls[:, :, 1], thresh=(edge2_value, 255))
    ...
    _, s_binary = edge.threshold(s_channel, (edge_value, 255))
    ...
    _, r_thresh = edge.threshold(frame[:, :, 2], thresh=(edge3_value, 255))
